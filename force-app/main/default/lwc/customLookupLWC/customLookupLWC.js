...
import getLookupValues from '@salesforce/apex/oppoOrdPaymentHelper.getLookupValues';
import getinitRecord from '@salesforce/apex/oppoOrdPaymentHelper.getinitRecord';
import gerRecentlyCreatedRecords from '@salesforce/apex/oppoOrdPaymentHelper.gerRecentlyCreatedRecords';

export default class CustomLookupLWC extends LightningElement {
    //public properties
    @api uniqueName = 'Product2';
    @api initialLookupValue = '';
    @api objectAPIName = 'Product2';
    displayLabelField = 'Name';
    @api iconName = 'standard:Product';
    @api labelForComponent = 'Product'
    @api placeHolder = 'Search Product'
    @api recordLimit = 10;
    @api labelHidden = false;
    searchKeyWord = '';
    @api selectedRecord = {}; // Use, for store SELECTED sObject Record
    @api where = ' Id IN (SELECT Product2Id FROM PricebookEntry WHERE Pricebook2Id =  ';
    selectedCandidateId = '';
